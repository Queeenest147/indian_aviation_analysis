CREATE TABLE flight_data.business_cleaned(
	"date" TEXT,
	airline TEXT,
	ch_code TEXT,
	num_code TEXT,
...
INSERT INTO flight_data.business_cleaned("date", airline, ch_code, 
...
FROM flight_data.business_flight;
									
SELECT * FROM flight_data.business_cleaned; 

-- date column
ALTER TABLE flight_data.business_cleaned
...
UPDATE flight_data.business_cleaned 
...
USING REPLACE(price, ',', '')::INT;

ALTER TABLE flight_data.business_new
ADD COLUMN airline_class TEXT;

UPDATE flight_data.business_new
SET airline_class = 'Business';

SELECT price FROM flight_data.business_new;



-- Checking for dulicates 
CREATE TABLE flight_data.business_new AS
SELECT DISTINCT ON (flight_date, departure_city, destination_city, departure_time)
       *
FROM flight_data.business_cleaned
ORDER BY flight_date, departure_city, destination_city, departure_time, price ASC;

-- Checking for missing Values 
SELECT * FROM flight_data.business_new
WHERE price IS NULL;



SELECT * FROM flight_data.business_new LIMIT 10;